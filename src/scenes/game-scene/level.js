class Level {
  ...
  static collisionResponseFromBallToBlock(ball, manifest) {
    ...
    ball.position = {
      x: ball.position.x + manifest.circle.distance.x + (manifestDirection.x * ball.radius),
      y: ball.position.y + manifest.circle.distance.y + (manifestDirection.y * ball.radius)
    };
    ball.velocity = {
